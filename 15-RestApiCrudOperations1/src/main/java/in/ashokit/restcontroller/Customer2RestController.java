...
public class Customer2RestController {
	...
	public ResponseEntity<List<Customer>> getCustomers() {
		...
		logger.info("Customer2RestController :: getCustomers:: method executed...");
	...
	public ResponseEntity<Customer> insertCustomer(@RequestBody Customer customer) {
		...
		logger.info("Customer2RestController :: insertCustomer:: method executed...");
	...
	public ResponseEntity<Customer> updateCustomer(@PathVariable Integer customerId,
		...
		logger.info("Customer2RestController :: updateCustomer:: method executed...");
	...
	public ResponseEntity<Void> deleteCustomer(@PathVariable Integer customerId) {
		...
		logger.info("Customer2RestController :: deleteCustomer:: method executed...");
